...
def upgrade() -> None:
    ...
    op.add_column('user_sessions', sa.Column('player_id', sa.Integer(), nullable=True))
    op.add_column('users', sa.Column('bot', sa.Boolean(), nullable=True, server_default='false'))
    op.add_column('users', sa.Column('username_as_player_name', sa.Boolean(), nullable=True, server_default='false'))
