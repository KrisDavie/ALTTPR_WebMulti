# This file is intended to be run from the DR codebase in order to generate the data files needed for WebMulti to function.
...
from MultiClient import location_table_uw, location_table_ow, location_table_misc, location_table_npc
